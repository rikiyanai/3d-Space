...
__webpack_require__.d(__webpack_exports__, {
  ...
  sM: () => (/* binding */ thurstonSph_FlatScreenRenderer),
  ...
  tz: () => (/* binding */ thurstonSph_ThurstonRecord),
  Ji: () => (/* binding */ thurstonSph_ThurstonRecordBM),
...
const thurstonSph_FlatScreenRenderer = specifyRenderer(FlatScreenRenderer, (part1_default()), (part2_default()));
...
const thurstonSph_ThurstonRecord = specifyThurston(ThurstonRecord, (part1_default()), (part2_default()));
const thurstonSph_ThurstonRecordBM = specifyThurston(ThurstonRecordBM, (part1_default()), (part2_default()));
