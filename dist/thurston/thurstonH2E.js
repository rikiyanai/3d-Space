...
__webpack_require__.d(__webpack_exports__, {
  ...
  K9: () => (/* binding */ thurstonH2E_BasicRenderer),
  ...
  Il: () => (/* reexport */ external_three_namespaceObject.Color),
  ...
  u0: () => (/* reexport */ LocalDirectedNoisyWSlabShape),
  QX: () => (/* reexport */ LocalDirectedWSlabShape),
  NQ: () => (/* reexport */ LocalHorizontalCylinder),
  h3: () => (/* reexport */ LocalHorizontalCylinderShape),
  UX: () => (/* reexport */ LocalNoisyVerticalCylinderShape),
  L8: () => (/* reexport */ LocalPointLight),
  XK: () => (/* reexport */ LocalStackBallShape),
  il: () => (/* reexport */ LocalStackNoisyWSlabShape),
  W1: () => (/* reexport */ LocalStackWSlabShape),
  IJ: () => (/* reexport */ LocalVerticalCylinder),
  jD: () => (/* reexport */ LocalVerticalCylinderShape),
  Sz: () => (/* reexport */ LocalWHalfSpace),
  Mu: () => (/* reexport */ LocalWHalfSpaceShape),
  Mk: () => (/* reexport */ LocalWSlab),
  kd: () => (/* reexport */ LocalWSlabShape),
  ...
  DZ: () => (/* binding */ thurstonH2E_PathTracerRenderer),
  ...
  sI: () => (/* reexport */ QuotientGenus2Material),
  pX: () => (/* reexport */ RIGHT),
  ...
  Ji: () => (/* binding */ thurstonH2E_ThurstonRecordBM),
  ...
  zO: () => (/* binding */ thurstonH2E_VRRenderer),
  ...
  dV: () => (/* reexport */ set),
  G0: () => (/* reexport */ union),
  dj: () => (/* reexport */ variableHeightQuotientGenus2_set),
...
;// CONCATENATED MODULE: ./src/geometries/h2e/geometry/Isometry.js
...
;// CONCATENATED MODULE: ./src/geometries/h2e/geometry/Point.js
...
;// CONCATENATED MODULE: ./src/geometries/h2e/geometry/Position.js
...
// EXTERNAL MODULE: ./src/geometries/h2e/geometry/shaders/part1.glsl
var part1 = __webpack_require__(7928);
var part1_default = /*#__PURE__*/__webpack_require__.n(part1);
// EXTERNAL MODULE: ./src/geometries/h2e/geometry/shaders/part2.glsl
var part2 = __webpack_require__(9822);
...
;// CONCATENATED MODULE: ./src/geometries/h2e/geometry/General.js
...
;// CONCATENATED MODULE: ./src/geometries/h2e/groups/cuspedTorus/set.js
...
const normalXp = new external_three_namespaceObject.Vector4(1, 0, -modelHalfCube, 0);
...
const normalXn = new external_three_namespaceObject.Vector4(-1, 0, -modelHalfCube, 0);
...
const normalYp = new external_three_namespaceObject.Vector4(0, 1, -modelHalfCube, 0);
...
const normalYn = new external_three_namespaceObject.Vector4(0, -1, -modelHalfCube, 0);
...
/* harmony default export */ const cuspedTorus_set = (new TeleportationSet()
...
;// CONCATENATED MODULE: ./src/geometries/h2e/groups/orbiTorus/set.js
...
const set_sqrt2 = Math.sqrt(2);
const aux = Math.pow(2, 0.25);
const shB = 1 / aux;
const chB = Math.sqrt(1 + set_sqrt2) / aux;
const height = Math.asinh(shB);

const set_normalXp = new external_three_namespaceObject.Vector4(chB, 0, -shB, 0);
...
const set_normalXn = new external_three_namespaceObject.Vector4(-chB, 0, -shB, 0);
...
const set_normalYp = new external_three_namespaceObject.Vector4(0, chB, -shB, 0);
...
const set_normalYn = new external_three_namespaceObject.Vector4(0, -chB, -shB, 0);
...
set_shiftWp.isom.makeTranslationFromDir(new Vector(0, 0, -2 * height));
set_shiftWn.isom.makeTranslationFromDir(new Vector(0, 0, 2 * height));


/* harmony default export */ const orbiTorus_set = (new TeleportationSet()
...
;// CONCATENATED MODULE: ./src/geometries/h2e/groups/plane/set.js
...
const plane_set_group = new isometry_Group_Group();

const plane_set_sqrt2 = Math.sqrt(2);
const set_aux = Math.pow(2, 0.25);
const set_shB = 1 / set_aux;
const set_chB = Math.sqrt(1 + plane_set_sqrt2) / set_aux;
const set_height = Math.asinh(set_shB);

const plane_set_normalXp = new external_three_namespaceObject.Vector4(set_chB, 0, -set_shB, 0);

function plane_set_testXp(p) {
    return p.coords.dot(plane_set_normalXp) > 0;
}

// language=GLSL
const plane_set_glslTestXp = `//
bool testXp(Point p){
    vec4 normal = vec4(${set_chB}, 0, -${set_shB}, 0);
    return dot(p.coords, normal) > 0.;
}
`;

const plane_set_normalXn = new external_three_namespaceObject.Vector4(-set_chB, 0, -set_shB, 0);

function plane_set_testXn(p) {
    return p.coords.dot(plane_set_normalXn) > 0;
}

// language=GLSL
const plane_set_glslTestXn = `//
bool testXn(Point p){
    vec4 normal = vec4(-${set_chB}, 0, -${set_shB}, 0);
    return dot(p.coords, normal) > 0.;
}
...
const plane_set_normalYp = new external_three_namespaceObject.Vector4(0, set_chB, -set_shB, 0);

function plane_set_testYp(p) {
    return p.coords.dot(plane_set_normalYp) > 0;
}

// language=GLSL
const plane_set_glslTestYp = `//
bool testYp(Point p){
    vec4 normal = vec4(0, ${set_chB}, -${set_shB}, 0);
    return dot(p.coords, normal) > 0.;
}
`;

const plane_set_normalYn = new external_three_namespaceObject.Vector4(0, -set_chB, -set_shB, 0);

function plane_set_testYn(p) {
    return p.coords.dot(plane_set_normalYn) > 0;
}

// language=GLSL
const plane_set_glslTestYn = `//
bool testYn(Point p){
    vec4 normal = vec4(0, -${set_chB}, -${set_shB}, 0);
    return dot(p.coords, normal) > 0.;
}
...
function plane_set_testWp(p) {
    return p.coords.w > set_height;
}


const plane_set_shiftXp = plane_set_group.element();
const plane_set_shiftXn = plane_set_group.element();
const plane_set_shiftYp = plane_set_group.element();
const plane_set_shiftYn = plane_set_group.element();

const set_sh2b = 2 * set_shB * set_chB;
const set_ch2B = 2 * set_chB * set_chB - 1;

plane_set_shiftXp.isom.matrix.set(
    set_ch2B, 0, -set_sh2b, 0,
    0, 1, 0, 0,
    -set_sh2b, 0, set_ch2B, 0,
    0, 0, 0, 1
);
plane_set_shiftXn.isom.matrix.set(
    set_ch2B, 0, set_sh2b, 0,
    0, 1, 0, 0,
    set_sh2b, 0, set_ch2B, 0,
    0, 0, 0, 1
);
plane_set_shiftYp.isom.matrix.set(
    1, 0, 0, 0,
    0, set_ch2B, -set_sh2b, 0,
    0, -set_sh2b, set_ch2B, 0,
    0, 0, 0, 1
);
plane_set_shiftYn.isom.matrix.set(
    1, 0, 0, 0,
    0, set_ch2B, set_sh2b, 0,
    0, set_sh2b, set_ch2B, 0,
    0, 0, 0, 1
...
/* harmony default export */ const plane_set = (new TeleportationSet()
    .add(plane_set_testXp, plane_set_glslTestXp, plane_set_shiftXp, plane_set_shiftXn)
    .add(plane_set_testXn, plane_set_glslTestXn, plane_set_shiftXn, plane_set_shiftXp)
    .add(plane_set_testYp, plane_set_glslTestYp, plane_set_shiftYp, plane_set_shiftYn)
    .add(plane_set_testYn, plane_set_glslTestYn, plane_set_shiftYn, plane_set_shiftYp));





;// CONCATENATED MODULE: ./src/geometries/h2e/groups/zLoop/set.js
...
function zLoop_set_testWp(p) {
    return p.coords.w > 1;
}

// language=GLSL
const zLoop_set_glslTestWp = `//
bool testWp(Point p){
    return p.coords.w > 1.;
}
`;

function zLoop_set_testWn(p) {
    return p.coords.w < -1.;
}

// language=GLSL
const zLoop_set_glslTestWn = `//
bool testWn(Point p){
    return p.coords.w < -1.;
}
`;

const zLoop_set_shiftWp = zLoop_set_group.element();
const zLoop_set_shiftWn = zLoop_set_group.element();

zLoop_set_shiftWp.isom.makeTranslationFromDir(new Vector(0, 0, -2));
zLoop_set_shiftWn.isom.makeTranslationFromDir(new Vector(0, 0, 2));


/* harmony default export */ const zLoop_set = (new TeleportationSet()
    .add(zLoop_set_testWp, zLoop_set_glslTestWp, zLoop_set_shiftWp, zLoop_set_shiftWn)
    .add(zLoop_set_testWn, zLoop_set_glslTestWn, zLoop_set_shiftWn, zLoop_set_shiftWp));

;// CONCATENATED MODULE: ./src/geometries/h2e/groups/horizontalLoop/GroupElement.js
...
class horizontalLoop_GroupElement_GroupElement extends GroupElement_GroupElement {
    ...
    clone() {
        const res = new horizontalLoop_GroupElement_GroupElement(this.group);
...
// EXTERNAL MODULE: ./src/geometries/h2e/groups/horizontalLoop/shaders/element.glsl
var horizontalLoop_shaders_element = __webpack_require__(4099);
var horizontalLoop_shaders_element_default = /*#__PURE__*/__webpack_require__.n(horizontalLoop_shaders_element);
// EXTERNAL MODULE: ./src/geometries/h2e/groups/horizontalLoop/shaders/struct.glsl
var horizontalLoop_shaders_struct = __webpack_require__(8846);
var horizontalLoop_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(horizontalLoop_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/groups/horizontalLoop/Group.js
...
class horizontalLoop_Group_Group extends Group_Group {
    ...
    constructor(halfTranslation = undefined) {
         ...
         * @type {Vector4}
         */
        this._halfTranslation = halfTranslation !== undefined ? halfTranslation : new external_three_namespaceObject.Vector4(1, 0, 0, 0);
    ...
    set halfTranslation(value) {
        this._halfTranslation = value !== undefined ? value : new external_three_namespaceObject.Vector4(1, 0, 0, 0);
        this._halfTranslation.setZ(0).setW(0);
    }

    get normalP() {
        const t = this.halfTranslation.length();
        return new external_three_namespaceObject.Vector4(
    ...
    element() {
        ...
        return new horizontalLoop_GroupElement_GroupElement(this, n)
    }

    shader(shaderBuilder) {
        shaderBuilder.addChunk((horizontalLoop_shaders_struct_default()));
        shaderBuilder.addUniform('group', 'Group', this);
        shaderBuilder.addChunk((horizontalLoop_shaders_element_default()));
    }
}
;// CONCATENATED MODULE: ./src/geometries/h2e/groups/horizontalLoop/set.js



const horizontalLoop_set_group = new horizontalLoop_Group_Group();

function testP(p) {
    return horizontalLoop_set_group.normalP.dot(p.coords) > 0;
}
...
function testN(p) {
    return horizontalLoop_set_group.normalN.dot(p.coords) < 0;
}
...
const shiftP = horizontalLoop_set_group.element(-1);
const shiftN = horizontalLoop_set_group.element(1);


/* harmony default export */ const horizontalLoop_set = (new TeleportationSet()
...
;// CONCATENATED MODULE: ./src/geometries/h2e/groups/genus2/set.js
...
const genus2_set_group = new isometry_Group_Group();
...
const set_set = new TeleportationSet();

// horizontal teleportations

identification.forEach(function (item) {
    const [i, j] = item;
    const shiftIJ = genus2_set_group.element();
    const shiftJI = genus2_set_group.element();
    ...
    const testIVec4 = new external_three_namespaceObject.Vector4(testIVec3.x, testIVec3.y, testIVec3.z, 0);
    ...
    set_set.add(testI, glslTestI, shiftIJ, shiftJI);

    const testJVec3 = octagon.normalTest(j);
    const testJVec4 = new external_three_namespaceObject.Vector4(testJVec3.x, testJVec3.y, testJVec3.z, 0);
    ...
    set_set.add(testJ, glslTestJ, shiftJI, shiftIJ);
});

// vertical teleportations

const [sh, _, ch] = octagon.sideCoords;
const genus2_set_height = Math.asinh(sh);


function genus2_set_testWp(p) {
    return p.coords.w > genus2_set_height;
}

// language=GLSL
const genus2_set_glslTestWp = `//
bool testWp(Point p){
    return p.coords.w > ${genus2_set_height};
}
`;

function genus2_set_testWn(p) {
    return p.coords.w < -genus2_set_height;
}

// language=GLSL
const genus2_set_glslTestWn = `//
bool testWn(Point p){
    return p.coords.w < -${genus2_set_height};
}
`;
...
const genus2_set_shiftWp = genus2_set_group.element();
const genus2_set_shiftWn = genus2_set_group.element();
genus2_set_shiftWp.isom.makeTranslationFromDir(new Vector(0, 0, -2 * genus2_set_height));
genus2_set_shiftWn.isom.makeTranslationFromDir(new Vector(0, 0, 2 * genus2_set_height));

set_set.add(genus2_set_testWp, genus2_set_glslTestWp, genus2_set_shiftWp, genus2_set_shiftWn);
set_set.add(genus2_set_testWn, genus2_set_glslTestWn, genus2_set_shiftWn, genus2_set_shiftWp);

/* harmony default export */ const genus2_set = (set_set);



;// CONCATENATED MODULE: ./src/geometries/h2e/groups/quotientGenus2/GroupElement.js
...
class quotientGenus2_GroupElement_GroupElement extends GroupElement_GroupElement {
    ...
    clone() {
        const res = new quotientGenus2_GroupElement_GroupElement(this.group);
        res.isom.copy(this.isom);
...
// EXTERNAL MODULE: ./src/geometries/h2e/groups/quotientGenus2/shaders/element.glsl
var quotientGenus2_shaders_element = __webpack_require__(5783);
var quotientGenus2_shaders_element_default = /*#__PURE__*/__webpack_require__.n(quotientGenus2_shaders_element);
;// CONCATENATED MODULE: ./src/geometries/h2e/groups/quotientGenus2/Group.js





class quotientGenus2_Group_Group extends Group_Group {
    ...
    element() {
        return new quotientGenus2_GroupElement_GroupElement(this);
    }

    shader(shaderBuilder) {
        shaderBuilder.addChunk((quotientGenus2_shaders_element_default()));
    }
}
;// CONCATENATED MODULE: ./src/geometries/h2e/groups/quotientGenus2/set.js
...
const quotientGenus2_set_group = new quotientGenus2_Group_Group();

const square = new RegularHypPolygon(4, Math.PI / 3);
// identification of the side of the octagon
// sides are numbered counter clock wise
const set_identification = [
    [0, 2],
    [1, 3]
]

const quotientGenus2_set_set = new TeleportationSet();

// horizontal teleportations

set_identification.forEach(function (item) {
    const [i, j] = item;
    const shiftIJ = quotientGenus2_set_group.element();
    const shiftJI = quotientGenus2_set_group.element();
    if (i === 0) {
    ...
    quotientGenus2_set_set.add(testI, glslTestI, shiftIJ, shiftJI);
    ...
    quotientGenus2_set_set.add(testJ, glslTestJ, shiftJI, shiftIJ);
});

// vertical teleportations

const [set_sh, set_, set_ch] = square.sideCoords;
const quotientGenus2_set_height = Math.asinh(set_sh);

function quotientGenus2_set_testWp(p) {
    return p.coords.w > quotientGenus2_set_height;
}

// language=GLSL
const quotientGenus2_set_glslTestWp = `//
bool testWp(Point p){
    return p.coords.w > ${quotientGenus2_set_height};
}
`;

function quotientGenus2_set_testWn(p) {
    return p.coords.w < -quotientGenus2_set_height;
}

// language=GLSL
const quotientGenus2_set_glslTestWn = `//
bool testWn(Point p){
    return p.coords.w < -${quotientGenus2_set_height};
}
`;
...
const quotientGenus2_set_shiftWp = quotientGenus2_set_group.element();
const quotientGenus2_set_shiftWn = quotientGenus2_set_group.element();
quotientGenus2_set_shiftWp.isom.makeTranslationFromDir(new Vector(0, 0, -2 * quotientGenus2_set_height));
quotientGenus2_set_shiftWn.isom.makeTranslationFromDir(new Vector(0, 0, 2 * quotientGenus2_set_height));

quotientGenus2_set_set.add(quotientGenus2_set_testWp, quotientGenus2_set_glslTestWp, quotientGenus2_set_shiftWp, quotientGenus2_set_shiftWn);
quotientGenus2_set_set.add(quotientGenus2_set_testWn, quotientGenus2_set_glslTestWn, quotientGenus2_set_shiftWn, quotientGenus2_set_shiftWp);

/* harmony default export */ const quotientGenus2_set = (quotientGenus2_set_set);



;// CONCATENATED MODULE: ./src/geometries/h2e/groups/horizontalQuotientGenus2/GroupElement.js
...
class horizontalQuotientGenus2_GroupElement_GroupElement extends GroupElement_GroupElement {
    ...
    clone() {
        const res = new horizontalQuotientGenus2_GroupElement_GroupElement(this.group);
        res.isom.copy(this.isom);
        res.finitePart.copy(this.finitePart);
        return res;
    }
...
// EXTERNAL MODULE: ./src/geometries/h2e/groups/horizontalQuotientGenus2/shaders/element.glsl
var horizontalQuotientGenus2_shaders_element = __webpack_require__(9236);
var horizontalQuotientGenus2_shaders_element_default = /*#__PURE__*/__webpack_require__.n(horizontalQuotientGenus2_shaders_element);
;// CONCATENATED MODULE: ./src/geometries/h2e/groups/horizontalQuotientGenus2/Group.js





class horizontalQuotientGenus2_Group_Group extends Group_Group {
    ...
    element() {
        return new horizontalQuotientGenus2_GroupElement_GroupElement(this);
    }

    shader(shaderBuilder) {
        shaderBuilder.addChunk((horizontalQuotientGenus2_shaders_element_default()));
    }
}
;// CONCATENATED MODULE: ./src/geometries/h2e/groups/horizontalQuotientGenus2/set.js
...
const horizontalQuotientGenus2_set_group = new horizontalQuotientGenus2_Group_Group();

const set_square = new RegularHypPolygon(4, Math.PI / 3);
// identification of the side of the octagon
// sides are numbered counter clock wise
const horizontalQuotientGenus2_set_identification = [
    [0, 2],
    [1, 3]
]

const horizontalQuotientGenus2_set_set = new TeleportationSet();

// horizontal teleportations

horizontalQuotientGenus2_set_identification.forEach(function (item) {
    const [i, j] = item;
    const shiftIJ = horizontalQuotientGenus2_set_group.element();
    const shiftJI = horizontalQuotientGenus2_set_group.element();
    if (i === 0) {
        shiftIJ.finitePart.set(0, -1);
        shiftJI.finitePart.set(0, -1);
    }
    ...
    shiftIJ.isom.matrix.setFromMatrix3(set_square.sideIdentification(i, j));
    shiftJI.isom.matrix.setFromMatrix3(set_square.sideIdentification(j, i));

    const testIVec3 = set_square.normalTest(i);
    const testIVec4 = new external_three_namespaceObject.Vector4(testIVec3.x, testIVec3.y, testIVec3.z, 0);
    ...
    horizontalQuotientGenus2_set_set.add(testI, glslTestI, shiftIJ, shiftJI);

    const testJVec3 = set_square.normalTest(j);
    const testJVec4 = new external_three_namespaceObject.Vector4(testJVec3.x, testJVec3.y, testJVec3.z, 0);
    ...
    horizontalQuotientGenus2_set_set.add(testJ, glslTestJ, shiftJI, shiftIJ);
});


/* harmony default export */ const horizontalQuotientGenus2_set = (horizontalQuotientGenus2_set_set);



;// CONCATENATED MODULE: ./src/geometries/h2e/groups/variableHeightQuotientGenus2/GroupElement.js
...
class variableHeightQuotientGenus2_GroupElement_GroupElement extends GroupElement_GroupElement {
    ...
    clone() {
        const res = new variableHeightQuotientGenus2_GroupElement_GroupElement(this.group);
        res.isom.copy(this.isom);
        res.finitePart.copy(this.finitePart);
        return res;
    }
...
// EXTERNAL MODULE: ./src/geometries/h2e/groups/variableHeightQuotientGenus2/shaders/struct.glsl
var variableHeightQuotientGenus2_shaders_struct = __webpack_require__(9910);
var variableHeightQuotientGenus2_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(variableHeightQuotientGenus2_shaders_struct);
// EXTERNAL MODULE: ./src/geometries/h2e/groups/variableHeightQuotientGenus2/shaders/element.glsl
var variableHeightQuotientGenus2_shaders_element = __webpack_require__(7624);
var variableHeightQuotientGenus2_shaders_element_default = /*#__PURE__*/__webpack_require__.n(variableHeightQuotientGenus2_shaders_element);
;// CONCATENATED MODULE: ./src/geometries/h2e/groups/variableHeightQuotientGenus2/Group.js
...
class variableHeightQuotientGenus2_Group_Group extends Group_Group {
    ...
    element() {
        return new variableHeightQuotientGenus2_GroupElement_GroupElement(this);
    }

    shader(shaderBuilder) {
        shaderBuilder.addChunk((variableHeightQuotientGenus2_shaders_struct_default()));
        shaderBuilder.addUniform('group', 'Group', this);
        shaderBuilder.addChunk((variableHeightQuotientGenus2_shaders_element_default()));
    }
}
;// CONCATENATED MODULE: ./src/geometries/h2e/groups/variableHeightQuotientGenus2/set.js
...
const variableHeightQuotientGenus2_set_group = new variableHeightQuotientGenus2_Group_Group();

const variableHeightQuotientGenus2_set_square = new RegularHypPolygon(4, Math.PI / 3);
// identification of the side of the octagon
// sides are numbered counter clock wise
const variableHeightQuotientGenus2_set_identification = [
    [0, 2],
    [1, 3]
]

const variableHeightQuotientGenus2_set_set = new TeleportationSet();

// horizontal teleportations

variableHeightQuotientGenus2_set_identification.forEach(function (item) {
    const [i, j] = item;
    const shiftIJ = variableHeightQuotientGenus2_set_group.element();
    const shiftJI = variableHeightQuotientGenus2_set_group.element();
    if (i === 0) {
        shiftIJ.finitePart.set(0, -1);
        shiftJI.finitePart.set(0, -1);
    }
    ...
    shiftIJ.isom.matrix.setFromMatrix3(variableHeightQuotientGenus2_set_square.sideIdentification(i, j));
    shiftJI.isom.matrix.setFromMatrix3(variableHeightQuotientGenus2_set_square.sideIdentification(j, i));

    const testIVec3 = variableHeightQuotientGenus2_set_square.normalTest(i);
    const testIVec4 = new external_three_namespaceObject.Vector4(testIVec3.x, testIVec3.y, testIVec3.z, 0);
    ...
    variableHeightQuotientGenus2_set_set.add(testI, glslTestI, shiftIJ, shiftJI);

    const testJVec3 = variableHeightQuotientGenus2_set_square.normalTest(j);
    const testJVec4 = new external_three_namespaceObject.Vector4(testJVec3.x, testJVec3.y, testJVec3.z, 0);
    ...
    variableHeightQuotientGenus2_set_set.add(testJ, glslTestJ, shiftJI, shiftIJ);
});

// vertical teleportations

function variableHeightQuotientGenus2_set_testWp(p) {
    return p.coords.w > variableHeightQuotientGenus2_set_group.halfHeight;
}

// language=GLSL
const variableHeightQuotientGenus2_set_glslTestWp = `//
bool testWp(Point p){
    return p.coords.w > group.halfHeight;
}
`;

function variableHeightQuotientGenus2_set_testWn(p) {
    return p.coords.w < -variableHeightQuotientGenus2_set_group.halfHeight;
}

// language=GLSL
const variableHeightQuotientGenus2_set_glslTestWn = `//
bool testWn(Point p){
    return p.coords.w < -group.halfHeight;
}
`;
...
const variableHeightQuotientGenus2_set_shiftWp = variableHeightQuotientGenus2_set_group.element();
const variableHeightQuotientGenus2_set_shiftWn = variableHeightQuotientGenus2_set_group.element();
variableHeightQuotientGenus2_set_shiftWp.isom.makeTranslationFromDir(new Vector(0, 0, -2 * variableHeightQuotientGenus2_set_group.halfHeight));
variableHeightQuotientGenus2_set_shiftWn.isom.makeTranslationFromDir(new Vector(0, 0, 2 * variableHeightQuotientGenus2_set_group.halfHeight));

variableHeightQuotientGenus2_set_set.add(variableHeightQuotientGenus2_set_testWp, variableHeightQuotientGenus2_set_glslTestWp, variableHeightQuotientGenus2_set_shiftWp, variableHeightQuotientGenus2_set_shiftWn);
variableHeightQuotientGenus2_set_set.add(variableHeightQuotientGenus2_set_testWn, variableHeightQuotientGenus2_set_glslTestWn, variableHeightQuotientGenus2_set_shiftWn, variableHeightQuotientGenus2_set_shiftWp);

variableHeightQuotientGenus2_set_set.setHalfHeight = function(value) {
    variableHeightQuotientGenus2_set_set.group.halfHeight = value;
    variableHeightQuotientGenus2_set_shiftWp.isom.makeTranslationFromDir(new Vector(0, 0, -2 * variableHeightQuotientGenus2_set_group.halfHeight));
    variableHeightQuotientGenus2_set_shiftWn.isom.makeTranslationFromDir(new Vector(0, 0, 2 * variableHeightQuotientGenus2_set_group.halfHeight));
}

/* harmony default export */ const variableHeightQuotientGenus2_set = (variableHeightQuotientGenus2_set_set);



// EXTERNAL MODULE: ./src/geometries/h2e/imports/direction.glsl
var direction = __webpack_require__(4761);
var direction_default = /*#__PURE__*/__webpack_require__.n(direction);
// EXTERNAL MODULE: ./src/geometries/h2e/imports/distance.glsl
var distance = __webpack_require__(5912);
var distance_default = /*#__PURE__*/__webpack_require__.n(distance);
// EXTERNAL MODULE: ./src/geometries/h2e/imports/lightIntensity.glsl
var lightIntensity = __webpack_require__(3820);
var lightIntensity_default = /*#__PURE__*/__webpack_require__.n(lightIntensity);
// EXTERNAL MODULE: ./src/geometries/h2e/lights/pointLight/shaders/struct.glsl
var pointLight_shaders_struct = __webpack_require__(6489);
...
;// CONCATENATED MODULE: ./src/geometries/h2e/lights/pointLight/PointLight.js
...
// EXTERNAL MODULE: ./src/geometries/h2e/lights/esun/shaders/struct.glsl
var esun_shaders_struct = __webpack_require__(6671);
var esun_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(esun_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/lights/esun/ESun.js
...
// EXTERNAL MODULE: ./src/geometries/h2e/lights/constDirLight/shaders/struct.glsl
var constDirLight_shaders_struct = __webpack_require__(7821);
var constDirLight_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(constDirLight_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/lights/constDirLight/ConstDirLight.js
...
// EXTERNAL MODULE: ./src/geometries/h2e/lights/localPointLight/shaders/struct.glsl
var localPointLight_shaders_struct = __webpack_require__(9250);
var localPointLight_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(localPointLight_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/lights/localPointLight/LocalPointLight.js
...
var varyingColor_shaders_struct = __webpack_require__(6882);
var varyingColor_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(varyingColor_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/material/varyingColor/VaryingColorMaterial.js
...
// EXTERNAL MODULE: ./src/geometries/h2e/material/quotientGenus2/shaders/struct.glsl
var quotientGenus2_shaders_struct = __webpack_require__(1603);
var quotientGenus2_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(quotientGenus2_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/material/quotientGenus2/QuotientGenus2Material.js
 ...
 */
class QuotientGenus2Material extends Material {
    ...
    static glslClass() {
        return (quotientGenus2_shaders_struct_default());
    }
...
// EXTERNAL MODULE: ./src/geometries/h2e/material/multiColor/shaders/struct.glsl
var multiColor_shaders_struct = __webpack_require__(574);
var multiColor_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(multiColor_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/material/multiColor/MultiColorMaterial.js
...
;// CONCATENATED MODULE: ./src/geometries/h2e/material/all.js



// EXTERNAL MODULE: ./src/geometries/h2e/shapes/ball/shaders/struct.glsl
var ball_shaders_struct = __webpack_require__(3021);
...
;// CONCATENATED MODULE: ./src/geometries/h2e/shapes/ball/BallShape.js
...
class WHalfSpaceShape extends BasicShape {
    ...
    static glslClass() {
        return (wHalfSpace_shaders_struct_default());
    }
...
// EXTERNAL MODULE: ./src/geometries/h2e/shapes/verticalCylinder/shaders/struct.glsl
var verticalCylinder_shaders_struct = __webpack_require__(807);
var verticalCylinder_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(verticalCylinder_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/shapes/verticalCylinder/VerticalCylinderShape.js
...
class VerticalCylinderShape extends BasicShape {
    ...
    updateData() {
        ...
        const dir = new external_three_namespaceObject.Vector4(0, 0, 0, 1).applyMatrix4(this.absoluteIsom.matrix);
...
// EXTERNAL MODULE: ./src/geometries/h2e/shapes/localVerticalCylinder/shaders/struct.glsl
var localVerticalCylinder_shaders_struct = __webpack_require__(4214);
var localVerticalCylinder_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(localVerticalCylinder_shaders_struct);
// EXTERNAL MODULE: ./src/geometries/h2e/imports/noise.glsl
var noise = __webpack_require__(8578);
var noise_default = /*#__PURE__*/__webpack_require__.n(noise);
;// CONCATENATED MODULE: ./src/geometries/h2e/shapes/localVerticalCylinder/LocalVerticalCylinderShape.js
...
// EXTERNAL MODULE: ./src/geometries/h2e/shapes/horizontalCylinder/shaders/struct.glsl
var horizontalCylinder_shaders_struct = __webpack_require__(9577);
var horizontalCylinder_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(horizontalCylinder_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/shapes/horizontalCylinder/HorizontalCylinderShape.js
...
class HorizontalCylinderShape extends BasicShape {
    ...
    updateData() {
        super.updateData();
        const pos = new Point().applyIsometry(this.absoluteIsom);
        const dir = new external_three_namespaceObject.Vector4(1, 0, 0, 0).applyMatrix4(this.absoluteIsom.matrix);
        this._vector = {pos: pos, dir: dir};
    }
    ...
    get uniformType() {
        return 'HorizontalCylinderShape';
    }

    static glslClass() {
        return (horizontalCylinder_shaders_struct_default());
    }
...
// EXTERNAL MODULE: ./src/geometries/h2e/shapes/localHorizontalCylinder/shaders/struct.glsl
var localHorizontalCylinder_shaders_struct = __webpack_require__(7177);
var localHorizontalCylinder_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(localHorizontalCylinder_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/shapes/localHorizontalCylinder/LocalHorizontalCylinderShape.js
...
class LocalHorizontalCylinderShape extends BasicShape {
    ...
    static glslClass() {
        return (localHorizontalCylinder_shaders_struct_default());
    }
...
// EXTERNAL MODULE: ./src/geometries/h2e/shapes/localWHalfSpace/shaders/struct.glsl
var localWHalfSpace_shaders_struct = __webpack_require__(6216);
var localWHalfSpace_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(localWHalfSpace_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/shapes/localWHalfSpace/LocalWHalfSpaceShape.js
...
class LocalWHalfSpaceShape extends BasicShape {
    ...
    get uniformType() {
        return 'LocalWHalfSpaceShape';
    }

    static glslClass() {
        return (localWHalfSpace_shaders_struct_default());
    }
...
// EXTERNAL MODULE: ./src/geometries/h2e/shapes/localWSlab/shaders/struct.glsl
var localWSlab_shaders_struct = __webpack_require__(9290);
var localWSlab_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(localWSlab_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/shapes/localWSlab/LocalWSlabShape.js
...
class LocalWSlabShape extends BasicShape {
    ...
    static glslClass() {
        return (localWSlab_shaders_struct_default());
    }
...
// EXTERNAL MODULE: ./src/geometries/h2e/shapes/localDirectedNoisyWSlab/shaders/struct.glsl
var localDirectedNoisyWSlab_shaders_struct = __webpack_require__(5043);
var localDirectedNoisyWSlab_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(localDirectedNoisyWSlab_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/shapes/localDirectedNoisyWSlab/LocalDirectedNoisyWSlabShape.js
...
class LocalDirectedNoisyWSlabShape extends BasicShape {
    ...
    constructor(location,thickness) {
        ...
        super(isom);
        this.addImport((distance_default()), (direction_default()), (noise_default()));
        this.thickness = thickness;
        this._origin = undefined;
    }
     ...
     * @type {boolean}
     */
    get isLocalDirectedNoisyWSlabShape() {
        return true;
    }
    ...
    get uniformType() {
        return 'LocalDirectedNoisyWSlabShape';
    }

    static glslClass() {
        return (localDirectedNoisyWSlab_shaders_struct_default());
    }
...
// EXTERNAL MODULE: ./src/geometries/h2e/shapes/localNoisyVerticalCylinder/shaders/struct.glsl
var localNoisyVerticalCylinder_shaders_struct = __webpack_require__(4347);
var localNoisyVerticalCylinder_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(localNoisyVerticalCylinder_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/shapes/localNoisyVerticalCylinder/LocalNoisyVerticalCylinderShape.js
...
class LocalNoisyVerticalCylinderShape extends BasicShape {
    ...
    static glslClass() {
        return (localNoisyVerticalCylinder_shaders_struct_default());
    }
...
// EXTERNAL MODULE: ./src/geometries/h2e/shapes/localStackNoisyWSlab/shaders/struct.glsl
var localStackNoisyWSlab_shaders_struct = __webpack_require__(1558);
var localStackNoisyWSlab_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(localStackNoisyWSlab_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/shapes/localStackNoisyWSlab/LocalStackNoisyWSlabShape.js
...
class LocalStackNoisyWSlabShape extends BasicShape {
     ...
     * @type {boolean}
     */
    get isLocalStackNoisyWSlabShape() {
        return true;
    }
    ...
    get uniformType() {
        return 'LocalStackNoisyWSlabShape';
    }

    static glslClass() {
        return (localStackNoisyWSlab_shaders_struct_default());
    }
...
// EXTERNAL MODULE: ./src/geometries/h2e/shapes/localStackWSlab/shaders/struct.glsl
var localStackWSlab_shaders_struct = __webpack_require__(5992);
var localStackWSlab_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(localStackWSlab_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/shapes/localStackWSlab/LocalStackWSlabShape.js
...
class LocalStackWSlabShape extends BasicShape {
    ...
    static glslClass() {
        return (localStackWSlab_shaders_struct_default());
    }
...
// EXTERNAL MODULE: ./src/geometries/h2e/shapes/localStackBall/shaders/struct.glsl
var localStackBall_shaders_struct = __webpack_require__(4491);
var localStackBall_shaders_struct_default = /*#__PURE__*/__webpack_require__.n(localStackBall_shaders_struct);
;// CONCATENATED MODULE: ./src/geometries/h2e/shapes/localStackBall/LocalStackBallShape.js
...
class LocalStackBallShape extends BasicShape {
    ...
    static glslClass() {
        return (localStackBall_shaders_struct_default());
    }
...
;// CONCATENATED MODULE: ./src/geometries/h2e/solids/Ball.js
...
;// CONCATENATED MODULE: ./src/geometries/h2e/solids/LocalBall.js
...
;// CONCATENATED MODULE: ./src/geometries/h2e/solids/WHalfSpace.js
 ...
 * Half space {w < 0}
 */
class WHalfSpace extends Solid {
...
;// CONCATENATED MODULE: ./src/geometries/h2e/solids/VerticalCylinder.js
...
;// CONCATENATED MODULE: ./src/geometries/h2e/solids/LocalVerticalCylinder.js
...
;// CONCATENATED MODULE: ./src/geometries/h2e/solids/HorizontalCylinder.js
 ...
 */
class HorizontalCylinder extends Solid {
...
;// CONCATENATED MODULE: ./src/geometries/h2e/solids/LocalHorizontalCylinder.js
 ...
 * Horizontal cylinder in H2 x E.
 */
class LocalHorizontalCylinder extends Solid {
...
;// CONCATENATED MODULE: ./src/geometries/h2e/solids/LocalWHalfSpace.js
 ...
 * Half space {w < 0}
 */
class LocalWHalfSpace extends Solid {
...
;// CONCATENATED MODULE: ./src/geometries/h2e/solids/LocalWSlab.js
 ...
 * Slab {|w| < thickness}
 */
class LocalWSlab extends Solid {
...
;// CONCATENATED MODULE: ./src/geometries/h2e/solids/all.js
...
;// CONCATENATED MODULE: ./src/thurstonH2E.js
...
const thurstonH2E_Thurston = specifyThurston(Thurston, (part1_default()), (part2_default()));
const thurstonH2E_ThurstonLite = specifyThurston(ThurstonLite, (part1_default()), (part2_default()));
...
const thurstonH2E_ThurstonRecordBM = specifyThurston(ThurstonRecordBM, (part1_default()), (part2_default()));
...
var __webpack_exports__LocalDirectedNoisyWSlabShape = __webpack_exports__.u0;
...
var __webpack_exports__LocalNoisyVerticalCylinderShape = __webpack_exports__.UX;
var __webpack_exports__LocalPointLight = __webpack_exports__.L8;
var __webpack_exports__LocalStackBallShape = __webpack_exports__.XK;
var __webpack_exports__LocalStackNoisyWSlabShape = __webpack_exports__.il;
var __webpack_exports__LocalStackWSlabShape = __webpack_exports__.W1;
...
var __webpack_exports__LocalWHalfSpace = __webpack_exports__.Sz;
var __webpack_exports__LocalWHalfSpaceShape = __webpack_exports__.Mu;
var __webpack_exports__LocalWSlab = __webpack_exports__.Mk;
var __webpack_exports__LocalWSlabShape = __webpack_exports__.kd;
...
var __webpack_exports__QuotientGenus2Material = __webpack_exports__.sI;
...
var __webpack_exports__WHalfSpace = __webpack_exports__.Uy;
var __webpack_exports__WHalfSpaceShape = __webpack_exports__.CI;
...
var __webpack_exports__genus2Set = __webpack_exports__.Zk;
...
var __webpack_exports__horizontalQuotientGenus2Set = __webpack_exports__.K2;
...
var __webpack_exports__orbiTorusSet = __webpack_exports__.mm;
var __webpack_exports__pathTracerWrap = __webpack_exports__.wS;
var __webpack_exports__phongWrap = __webpack_exports__.WT;
var __webpack_exports__planeSet = __webpack_exports__.cR;
var __webpack_exports__quotientGenus2Set = __webpack_exports__.pt;
...
var __webpack_exports__variableHeightQuotientGenus2Set = __webpack_exports__.dj;
